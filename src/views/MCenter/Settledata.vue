<template>
  <section class="apply me-wrap">
    ...
    <Settledatadetails v-if="flag" :cid='cid' :flag='flag' :uname='uname' :unionId='unionId' ref="editor" @cancel='cancel()' @refreshDataList="refreshData()"></Settledatadetails>
  </section>
</template>

<script>
import { channelSalaryList, unionRole } from "@/api/api";
import Settledatadetails from './Settledatadetails'
  ...
  methods: {
    ...
    //   },
      ...
      getchannelSalaryList(){
          ...
          channelSalaryList(data).then((res) => {
