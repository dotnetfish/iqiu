<template>
  <section class="apply me-wrap">
    ...
    <div style="display:flex;margin-top:34px;margin-left:154px">
        <div style="color:#ffffff;font-size:18px;height:40px;line-height:40px;width:200px;text-align:center;background-color:#F9772A;cursor: pointer;" @click="getunionadd">提交</div>
    </div>
  </section>
</template>
