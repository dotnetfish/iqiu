      ...
      <div class="nav-menu">
        ...
        <div class="nav-display">
          <div class="nav-left">
            ...
            <router-link :to="{name:'Ballplace'}" @click.native="navClickEvent('球场')">
              <div class="routing" v-if="$route.name !== 'Ballplace' ">球场</div>
              <div class="nav-routing-active" v-if="$route.name === 'Ballplace' ">球场</div>
            </router-link>
